...
from .data import InfeasibleOutcome, UnboundedOutcome, Outcome
from .executors import aiohttp_executor, Executor
...
class Client:
    ...
    async def create_inputs_builder(
        ...
        data = await self._executor.execute('@FetchOutline', {
    ...
    async def start_attempt(
        ...
        data = await self._executor.execute('@StartAttempt', {
            'input': {
